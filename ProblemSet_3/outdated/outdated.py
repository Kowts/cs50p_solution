# An array of MONTHS for converting a month name to the month's numeral
MONTHS: list[str] = [
    "January",
    "February",
    "March",
...
# Function to get the month numeral. Using a function is better because it can just
# return if the month is found instead of having to finish iterating the array.
...
# Function to check if the provided month and day are valid
